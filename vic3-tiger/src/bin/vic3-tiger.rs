...
use tiger_lib::{
    ...
    set_show_vanilla, validate_config_file, Everything, Game, ModMetadata,
};
...
fn main() -> Result<()> {
    ...
    // LAST UPDATED VERSION VIC3 1.5.13
    eprintln!("This validator was made for Victoria 3 version 1.5.13.");
