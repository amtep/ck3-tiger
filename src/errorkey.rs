...
impl FromStr for ErrorKey {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        let key = match s {
            ...
            "missing-dynasty" => ErrorKey::MissingDynasty,
            "missing-character" => ErrorKey::MissingCharacter,
            "missing-faith" => ErrorKey::MissingFaith,
...
impl Display for ErrorKey {
    fn fmt(&self, fmt: &mut Formatter) -> Result<(), std::fmt::Error> {
        match self {
            ...
            ErrorKey::MissingDynasty => write!(fmt, "missing-dynasty"),
            ErrorKey::MissingCharacter => write!(fmt, "missing-character"),
            ErrorKey::MissingFaith => write!(fmt, "missing-faith"),
