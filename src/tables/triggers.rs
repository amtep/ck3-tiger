...
const SCOPE_TRIGGER_TARGET: &[(u64, &str, u64)] = &[
    (AccoladeType, "accolade_type_tier", AccoladeType),
    (
        Character,
    ...
    (Character, "is_activity_type_on_cooldown", ActivityType),
    ...
    (Character, "is_diarch_of_target", Character),
    ...
    (Character, "is_important_decision", Decision),
    ...
    (CharacterMemory, "is_memory_of_travel", TravelPlan),
    (Character, "is_mercenary_in_hire_range", Character),
    (LandedTitle, "is_neighbor_to_realm", Character),
    (Character, "is_nibling_of", Character),
    (Trait, "is_opposite_of_trait", Trait),
    (Character, "is_parent_of", Character),
    (War, "is_participant", Character),
    (Character, "is_participant_in_activity", Activity),
    ...
    (Activity, "is_required_special_guest", Character),
    ...
    (Character, "should_decision_create_alert", Decision),
    (Character, "should_notify_can_host_activity", ActivityType),
    (
        Character,
...
const SCOPE_TRIGGER_BOOL: &[(u64, &str)] = &[
    ...
    (None, "always"),
    (Army, "army_is_moving"),
    (Character, "can_be_acclaimed"),
    (LandedTitle, "can_be_leased_out"),
    (TravelPlan, "can_cancel"),
    ...
    (Character, "has_potential_acclaimed_knights"),
    (Accolade, "has_potential_accolade_successors"),
    ...
    (Province, "has_stationed_regiment"),
    ...
    (TravelPlan, "is_aborted"),
    (Character, "is_acclaimed"),
    (Accolade, "is_accolade_active"),
    (Character, "is_accolade_successor"),
    (Activity, "is_activity_complete"),
    (Character, "is_adult"),
    (Character, "is_ai"),
    (Character, "is_alive"),
    ...
    (Province, "is_occupied"),
    (Activity, "is_open_invite_activity"),
    (Character, "is_overriding_designated_winner"),
    (TravelPlan, "is_paused"),
    ...
    (Character, "is_travel_entourage_character"),
    (Character, "is_travel_leader"),
    (Character, "is_travelling"),
    (None, "is_tutorial_active"),
    (Scheme, "is_type_secret"),
    ...
    (TravelPlan, "was_activity_completed"),
...
const SCOPE_TRIGGER_ITEM: &[(u64, &str, Item)] = &[
    ...
    (Accolade, "has_accolade_category", Item::AccoladeCategory),
    (Activity, "has_active_locale", Item::ActivityLocale),
    (Character, "has_active_mandate", Item::DiarchyMandate),
    (Character, "has_activity_intent", Item::ActivityIntent),
    (Character, "has_activity_state", Item::ActivityState),
    (Activity, "has_activity_type", Item::ActivityType),
    ...
    (Activity, "has_current_phase", Item::ActivityPhase),
    (
        Character,
        "has_diarchy_active_parameter",
        Item::DiarchyParameter,
    ),
    (Character, "has_diarchy_parameter", Item::DiarchyParameter),
    (Character, "has_diarchy_type", Item::DiarchyType),
    (None, "has_dlc_feature", Item::DlcFeature),
    ...
    (TravelPlan, "has_travel_option", Item::TravelOption),
    (
        TravelPlan,
    ...
    (Character, "has_vassal_stance", Item::VassalStance),
