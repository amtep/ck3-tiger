&[
    ...
    ("GetArticleType", Args::Args(&[DType(Unknown)]), Unknown),
    ...
    ("GetCommanderOrderType", Args::Args(&[DType(Unknown)]), Unknown),
    ("GetCompanyCharterType", Args::Args(&[DType(Unknown)]), Unknown),
    ...
    ("GetCountryStrategicObjectiveInStateDesc", Args::Args(&[DType(Unknown), DType(Unknown)]), CString),
    ...
    ("GetMapMode", Args::Args(&[DType(Unknown)]), Unknown),
    ...
    ("GetNumCommandersInSelectedFormationsWithOrderActive", Args::Args(&[DType(Unknown)]), int32),
    ("GetNumCommandersInSelectedFormationsWithOrderBlocked", Args::Args(&[DType(Unknown)]), int32),
    ("GetNumCommandersInSelectedFormationsWithOrderNext", Args::Args(&[DType(Unknown)]), int32),
    ("GetNumCommandersInSelectedFormationsWithOrderPossible", Args::Args(&[DType(Unknown)]), int32),
    ...
    ("IsRedundant", Args::Args(&[DType(Unknown)]), bool),
