...
const MODIF_TABLE: &[(&str, ModifKinds)] = &[
    ...
    ("building_input_mult", ModifKinds::Building),
    ...
    ("character_command_limit_combat_unit_conscript_add", ModifKinds::Character),
    ("character_command_limit_combat_unit_flotilla_add", ModifKinds::Character),
    ("character_command_limit_combat_unit_regular_add", ModifKinds::Character),
