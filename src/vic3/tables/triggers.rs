...
const TRIGGER: &[(Scopes, &str, Trigger)] = &[
    (Scopes::None, "active_lens", UncheckedValue),
    (Scopes::None, "active_lens_option", UncheckedValue),
    ...
    (
        ...
        Block(&[("target", Scope(Scopes::Country)), ("type", UncheckedValue)]),
    ),
    ...
    (
        Scopes::Country,
        "can_have_as_subject",
        Block(&[("who", Scope(Scopes::Country)), ("type", UncheckedValue)]),
    ),
    ...
    (Scopes::Character, "has_commander_order", UncheckedValue),
    (Scopes::Country, "has_completed_subgoal", UncheckedValue),
    ...
    (Scopes::Culture, "has_culture_graphics", UncheckedValue),
    (Scopes::Country, "has_decreasing_interests", Boolean),
    (Scopes::State, "has_decree", UncheckedValue),
    (
        Scopes::Country,
        "has_diplomatic_pact",
        Block(&[
    ...
    (Scopes::Culture.union(Scopes::Religion), "has_discrimination_trait", UncheckedValue),
    ...
    (Scopes::Country, "has_export_priority_tariffs", UncheckedValue),
    ...
    (Scopes::Country, "has_government_type", UncheckedValue),
    ...
    (Scopes::Character.union(Scopes::InterestGroup), "has_ideology", UncheckedValue),
    (Scopes::Country, "has_import_priority_tariffs", UncheckedValue),
    (Scopes::Country, "has_institution", UncheckedValue),
    ...
    (Scopes::Country, "has_journal_entry", UncheckedValue),
    (Scopes::Province, "has_label", UncheckedValue),
    (Scopes::Country, "has_law", UncheckedValue),
    (Scopes::None, "has_local_variable", UncheckedValue),
    (Scopes::None, "has_local_variable_list", UncheckedValue),
    (Scopes::None, "has_map_interaction", UncheckedValue),
    (Scopes::None, "has_map_interaction_diplomatic_action", UncheckedValue),
    (Scopes::None, "has_map_interaction_export_goods", UncheckedValue),
    (Scopes::None, "has_map_interaction_import_goods", UncheckedValue),
    (
        Scopes::Country
    ...
    (Scopes::Country, "has_no_priority_tariffs", UncheckedValue),
    (Scopes::Country, "has_objective", UncheckedValue),
    ...
    (Scopes::DiplomaticPlay, "has_play_goal", UncheckedValue),
    ...
    (Scopes::State, "has_potential_resource", UncheckedValue),
    (Scopes::Country, "has_potential_to_form_country", UncheckedValue),
    ...
    (Scopes::Country, "has_strategy", UncheckedValue),
    ...
    (Scopes::Country, "has_technology_researched", UncheckedValue),
    (Scopes::Character, "has_template", UncheckedValue),
    (Scopes::Province, "has_terrain", UncheckedValue),
    (Scopes::Character, "has_trait", UncheckedValue),
    (Scopes::Country, "has_treaty_port_in_country", Scope(Scopes::Country)),
    (Scopes::Country, "has_truce_with", Scope(Scopes::Country)),
    (Scopes::None, "has_unification_candidate", UncheckedValue),
    ...
    (Scopes::War, "has_war_goal", UncheckedValue),
    (
        Scopes::War,
        "has_war_support",
        Block(&[("target", Scope(Scopes::Country)), ("value", CompareValue)]),
    ...
    (Scopes::Building, "is_building_group", UncheckedValue),
    ...
    (Scopes::DiplomaticPact, "is_diplomatic_action_type", UncheckedValue),
    ...
    (Scopes::DiplomaticPlay, "is_diplomatic_play_type", UncheckedValue),
    ...
    (Scopes::Country, "is_enacting_law", UncheckedValue),
    ...
    (Scopes::Character.union(Scopes::InterestGroup), "is_interest_group_type", UncheckedValue),
    ...
    (Scopes::Party, "is_party_type", UncheckedValue),
    (Scopes::Country, "is_player", Boolean),
    (Scopes::PoliticalMovement, "is_political_movement_type", UncheckedValue),
    (Scopes::Pop, "is_pop_type", UncheckedValue),
    ...
    (Scopes::Country, "is_researching_technology_category", UncheckedValue),
    ...
    (Scopes::Country, "is_taxing_goods", UncheckedValue),
    ...
    (Scopes::Country, "is_unification_candidate", UncheckedValue),
    ...
    (Scopes::InterestGroup, "most_powerful_strata", UncheckedValue),
    (Scopes::State, "most_prominent_revolting_interest_group", UncheckedValue),
    ...
    (Scopes::Country, "owns_entire_state_region", UncheckedValue),
    (Scopes::Country, "owns_treaty_port_in", UncheckedValue),
    ...
    (Scopes::Country, "shrinking_institution", UncheckedValue),
    ...
    (Scopes::Country, "was_formed_from", UncheckedValue),
