...
const TRIGGER_COMPLEX: &[(Scopes, &str, ArgumentValue)] = {
    ...
    &[
        ...
        (Scopes::PowerBloc, "power_bloc_wrost_economic_dependence_with", Scope(Scopes::Country)),
        (Scopes::PowerBloc, "power_bloc_wrost_economic_dependence_without", Scope(Scopes::Country)),
