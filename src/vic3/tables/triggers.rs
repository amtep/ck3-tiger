...
const TRIGGER: &[(u64, &str, RawTrigger)] = &[
    ...
    (Country, "ai_army_comparison(", CompareValue),
    (Country, "ai_gdp_comparison(", CompareValue),
    (Country, "ai_ideological_opinion(", CompareValue),
    (Country, "ai_navy_comparison(", CompareValue),
    ...
    (Front, "average_defense(", CompareValue),
    (Country, "average_incorporated_country_infrastructure", CompareValue),
    (Front, "average_offense(", CompareValue),
    (
        Battle,
    ...
    (Country, "can_establish_any_export_route", ScopeOrItem(Goods, Item::Goods)),
    (Country, "can_establish_any_import_route", ScopeOrItem(Goods, Item::Goods)),
    (Country, "can_form_nation", Item(Item::Country)),
    (Country, "can_have_as_subject", Block(&[("who", Scope(Country)), ("type", UncheckedValue)])),
    ...
    (Country, "construction_queue_government_duration", CompareValue),
    (Country, "construction_queue_num_queued_government_levels", CompareValue),
    (Country, "construction_queue_num_queued_levels", CompareValue),
    (Country, "construction_queue_num_queued_private_levels", CompareValue),
    (Country, "construction_queue_private_duration", CompareValue),
    (StateRegion, "contains_capital_of", ScopeOrItem(Country, Item::Country)),
    (CountryDefinition, "country_definition_has_culture", Scope(Culture)),
    (Country, "country_has_primary_culture", Scope(Culture)),
    (Country, "country_has_state_religion", Scope(Religion)),
    (Country, "country_or_subject_owns_entire_state_region", Item(Item::StateRegion)),
    (
        Country,
        "country_pm_usage",
        Block(&[
    ...
    (State, "culture_percent_state", Block(&[("target", Scope(Culture)), ("value", CompareValue)])),
    (
        Culture,
    ...
    (Country, "enactment_chance_without_enactment_modifier", CompareValue),
    ...
    (None, "exists", Special),
    (Country, "expanding_institution", ScopeOrItem(InstitutionType, Item::Institution)),
    ...
    (Building, "has_active_production_method", Item(Item::ProductionMethod)),
    ...
    (
        Country,
        "has_diplomatic_pact",
        Block(&[("who", Scope(Country)), ("type", UncheckedValue), ("?is_initiator", Boolean)]),
    ),
    ...
    (Culture | Religion, "has_discrimination_trait", UncheckedValue),
    ...
    (Country, "has_interest_marker_in_region", ScopeOrItem(StrategicRegion, Item::StrategicRegion)),
    ...
    (None, "has_map_interaction_diplomatic_action", UncheckedValue),
    ...
    (InterestGroup, "interest_group_population_percentage", CompareValue),
    (InterestGroup, "interest_group_supports_political_movement", Boolean),
    ...
    (Country, "is_banning_goods", ScopeOrItem(Goods, Item::Goods)),
    ...
    (None, "is_building_type_expanded", ScopeOrItem(BuildingType, Item::BuildingType)),
    (Character, "is_busy", Boolean),
    (State, "is_capital", Boolean),
    (Character, "is_character_alive", Boolean),
    (CivilWar, "is_civil_war_type", Choice(&["revolution", "secession"])),
    ...
    (StateRegion, "is_homeland", ScopeOrItem(Culture, Item::Culture)),
    ...
    (Character | InterestGroup, "is_interest_group_type", UncheckedValue),
    ...
    (None, "is_lens_open", Block(&[("lens", UncheckedValue), ("tab_name", UncheckedValue)])),
    ...
    (PoliticalMovement, "is_political_movement_type", UncheckedValue),
    ...
    (Country, "is_researching_technology_category", UncheckedValue),
    ...
    (InterestGroup, "is_same_interest_group_type", Scope(InterestGroup)),
    ...
    (
        ...
        Block(&[("who", Scope(Country)), ("country_formation", UncheckedValue)]),
    ),
    (
        None,
    ...
    (State, "most_prominent_revolting_interest_group", UncheckedValue),
    (None, "nand", Control),
    (Country, "navy_reserves", CompareValue),
    (None, "nor", Control),
    (None, "not", Control),
    (Country, "num_alliances_and_defensive_pacts_with_allies(", CompareValue),
    (Country, "num_alliances_and_defensive_pacts_with_rivals(", CompareValue),
    (War, "num_casualties", CompareValue),
    (War, "num_country_casualties", Block(&[("target", Scope(Country)), ("value", CompareValue)])),
    (War, "num_country_dead", Block(&[("target", Scope(Country)), ("value", CompareValue)])),
    ...
    (Country, "num_mutual_trade_route_levels_with_country(", CompareValue),
    ...
    (PoliticalMovement, "political_movement_radicalism", CompareValue),
    ...
    (
        InterestGroup,
        "prefers_law",
        Block(&[("law", Scope(LawType)), ("comparison_law", Scope(LawType))]),
    ),
    ...
    (Culture, "shares_heritage_and_other_trait_with_any_primary_culture", Scope(Country)),
    (Culture, "shares_heritage_trait_with_any_primary_culture", Scope(Country)),
    (Religion, "shares_heritage_trait_with_state_religion", Scope(Country)),
    (Culture, "shares_non_heritage_trait_with_any_primary_culture", Scope(Country)),
    (Culture, "shares_trait_with_any_primary_culture", Scope(Country)),
