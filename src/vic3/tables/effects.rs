...
const SCOPE_EFFECT: &[(Scopes, &str, Effect)] = &[
    ...
    (Scopes::Pop, "add_pop_wealth", Unchecked), // no examples in vanilla
    ...
    (Scopes::DiplomaticPlay, "add_target_backers", Unchecked), // no examples in vanilla
    ...
    (Scopes::Country, "remove_enactment_modifier", Unchecked), // No examples in vanilla
    ...
    (Scopes::DiplomaticPlay, "remove_initiator_backers", Unchecked), // No examples in vanilla
    ...
    (Scopes::DiplomaticPlay, "remove_target_backers", Unchecked), // No exmaples in vanilla
