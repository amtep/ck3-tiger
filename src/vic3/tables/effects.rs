...
const SCOPE_EFFECT: &[(Scopes, &str, Effect)] = &[
    ...
    (Scopes::Country, "add_change_relations_progress", UncheckedTodo), // Not used in vanilla
    ...
    (Scopes::DiplomaticPlay, "add_initiator_backers", UncheckedTodo), // Not used in vanilla
    ...
    (Scopes::State, "add_religion_standard_of_living_modifier", UncheckedTodo),
    (Scopes::InterestGroup, "add_ruling_interest_group", Boolean),
    (Scopes::DiplomaticPlay, "add_target_backers", UncheckedTodo), // no examples in vanilla
    ...
    (Scopes::Country, "create_diplomatic_pact", UncheckedTodo),
    (Scopes::Country, "create_diplomatic_play", UncheckedTodo),
    (Scopes::Country, "create_incident", UncheckedTodo),
    ...
    (Scopes::Country, "end_truce", UncheckedTodo),
    ...
    (Scopes::Country, "remove_diplomatic_pact", UncheckedTodo),
    ...
    (Scopes::DiplomaticPlay, "remove_initiator_backers", UncheckedTodo), // No examples in vanilla
    ...
    (Scopes::DiplomaticPlay, "remove_target_backers", UncheckedTodo), // No examples in vanilla
    ...
    (Scopes::DiplomaticPlay, "remove_war_goal", UncheckedTodo),
    ...
    (Scopes::Country, "set_mutual_secret_goal", UncheckedTodo),
    ...
    (Scopes::Country, "set_tension", UncheckedTodo),
