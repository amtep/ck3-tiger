...
const SCOPE_EFFECT: &[(Scopes, &str, Effect)] = &[
    ...
    (Scopes::StateRegion, "add_arable_land", Integer),
    (Scopes::Country, "add_banned_goods", Scope(Scopes::Goods)),
    (Scopes::Country, "add_change_relations_progress", Unchecked), // Not used in vanilla
    ...
    (Scopes::State, "add_culture_standard_of_living_modifier", VB(EvB::AddCultureSolModifier)),
    (Scopes::Country, "add_declared_interest", Item(Item::StrategicRegion)),
    (Scopes::StateRegion, "add_devastation", Integer),
    (
    ...
    (Scopes::DiplomaticPlay, "add_initiator_backers", Unchecked), // Not used in vanilla
    (Scopes::Country, "add_investment_pool", ScriptValue),
    (Scopes::None, "add_journal_entry", VB(EvB::AddJournalentry)),
    (Scopes::Country, "add_law_progress", ScriptValue),
    (Scopes::Country, "add_loyalists", VB(EvB::AddLoyalists)),
    (Scopes::State, "add_loyalists_in_state", VB(EvB::AddLoyalists)),
    (
        Scopes::Country
    ...
    (Scopes::Pop, "add_pop_wealth", Unchecked),
    (Scopes::Country, "add_primary_culture", Scope(Scopes::Culture)),
    (Scopes::Country, "add_radicals", VB(EvB::AddLoyalists)),
    (Scopes::State, "add_radicals_in_state", VB(EvB::AddLoyalists)),
    (Scopes::Character, "add_random_trait", Choice(&["personality", "skill", "condition"])),
    (Scopes::State, "add_religion_standard_of_living_modifier", Unchecked),
    (Scopes::InterestGroup, "add_ruling_interest_group", Boolean),
    (Scopes::DiplomaticPlay, "add_target_backers", Unchecked),
    (Scopes::Country, "add_taxed_goods", Scope(Scopes::Goods)),
    (Scopes::Country, "add_technology_progress", Unchecked),
    ...
    (Scopes::Character, "add_trait", Unchecked),
    (Scopes::Country, "add_treasury", ScriptValue),
    (Scopes::War, "add_war_exhaustion", Unchecked),
    (Scopes::DiplomaticPlay, "add_war_goal", Unchecked),
    (Scopes::War, "add_war_war_support", Unchecked),
    ...
    (Scopes::Country, "call_election", Unchecked),
    ...
    (Scopes::Country, "change_institution_investment_level", Unchecked),
    (Scopes::None, "change_local_variable", VB(EvB::ChangeVariable)),
    (Scopes::Pop, "change_pop_culture", Unchecked),
    (Scopes::Pop, "change_pop_religion", Unchecked),
    (Scopes::Pop, "change_poptype", Scope(Scopes::PopType)),
    (Scopes::Country, "change_relations", Unchecked),
    (Scopes::Country, "change_subject_type", Unchecked),
    (Scopes::Country, "change_tag", Item(Item::Country)),
    (Scopes::Country, "change_tension", Unchecked),
    ...
    (Scopes::Country, "complete_objective_subgoal", Unchecked),
    (Scopes::State, "convert_population", Unchecked),
    (Scopes::State, "create_building", Unchecked),
    (Scopes::Country, "create_character", Unchecked),
    (Scopes::None, "create_country", Unchecked),
    (Scopes::Country, "create_diplomatic_pact", Unchecked),
    (Scopes::Country, "create_diplomatic_play", Unchecked),
    (Scopes::Country, "create_incident", Unchecked),
    (Scopes::State, "create_pop", Unchecked),
    (Scopes::StateRegion, "create_state", Unchecked),
    (Scopes::Country, "create_trade_route", Unchecked),
    (Scopes::Country, "create_truce", Unchecked),
    ...
    (Scopes::Country, "end_truce", Unchecked),
    (Scopes::Character, "exile_character", Yes),
    (Scopes::State, "force_resource_depletion", Unchecked),
    (Scopes::State, "force_resource_discovery", Unchecked),
    ...
    (Scopes::Character, "kill_character", Unchecked),
    (Scopes::Country, "kill_population_percent", Unchecked),
    (Scopes::State, "kill_population_percent_in_state", Unchecked),
    (Scopes::TradeRoute, "lock_trade_route", Unchecked),
    ...
    (Scopes::None, "post_notification", Unchecked),
    (Scopes::None, "post_proposal", Unchecked),
    ...
    (Scopes::Country, "remove_active_objective_subgoal", Unchecked),
    ...
    (Scopes::Country, "remove_diplomatic_pact", Unchecked),
    (Scopes::Country, "remove_enactment_modifier", Unchecked),
    ...
    (Scopes::DiplomaticPlay, "remove_initiator_backers", Unchecked),
    ...
    (Scopes::DiplomaticPlay, "remove_target_backers", Unchecked),
    (Scopes::Country, "remove_taxed_goods", Scope(Scopes::Goods)),
    (Scopes::Character, "remove_trait", Unchecked),
    (Scopes::None, "remove_variable", Unchecked),
    (Scopes::DiplomaticPlay, "remove_war_goal", Unchecked),
    ...
    (Scopes::Country, "set_government_wage_level", Unchecked),
    ...
    (Scopes::Country, "set_institution_investment_level", Unchecked),
    ...
    (Scopes::Country, "set_military_wage_level", Unchecked),
    (Scopes::Country, "set_mutual_secret_goal", Unchecked),
    (Scopes::Country, "set_next_election_date", Date),
    (Scopes::Country, "set_owes_obligation_to", Unchecked),
    (Scopes::StateRegion, "set_owner_of_provinces", Unchecked),
    (Scopes::Pop, "set_pop_literacy", Unchecked),
    (Scopes::Pop, "set_pop_qualifications", Unchecked),
    (Scopes::Pop, "set_pop_wealth", Unchecked),
    (Scopes::Country, "set_relations", Unchecked),
    (Scopes::Country, "set_ruling_interest_groups", Unchecked),
    (Scopes::Party, "set_ruling_party", Yes),
    (Scopes::Country, "set_secret_goal", Unchecked),
    (Scopes::State, "set_state_owner", Scope(Scopes::Country)),
    (Scopes::Country, "set_state_religion", Scope(Scopes::Religion)),
    (Scopes::State, "set_state_type", Unchecked),
    (Scopes::Country, "set_strategy", Unchecked),
    (Scopes::Building, "set_subsidized", Boolean),
    (Scopes::Journalentry, "set_target_technology", Unchecked),
    ...
    (Scopes::Country, "set_tax_level", Unchecked),
    (Scopes::Country, "set_tension", Unchecked),
    ...
    (Scopes::Country, "take_on_scaled_debt", Unchecked),
    ...
    (Scopes::Country, "violate_sovereignty_join", Unchecked),
