...
const TRIGGER: &[(Scopes, &str, Trigger)] = &[
    ...
    (Scopes::Country, "all_active_scientist", UncheckedTodo),
    (Scopes::Country, "all_allied_country", UncheckedTodo),
    (Scopes::Country, "all_army_leader", UncheckedTodo),
    (Scopes::Country, "all_character", UncheckedTodo),
    (Scopes::Country, "all_controlled_state", UncheckedTodo),
    (Scopes::Country, "all_core_state", UncheckedTodo),
    (Scopes::None, "all_country", UncheckedTodo),
    (Scopes::None, "all_country_with_original_tag", UncheckedTodo),
    (Scopes::Country, "all_enemy_country", UncheckedTodo),
    (Scopes::Country, "all_guaranteed_country", UncheckedTodo),
    (Scopes::Country, "all_military_industrial_organization", UncheckedTodo),
    (Scopes::Country, "all_navy_leader", UncheckedTodo),
    (Scopes::Country, "all_neighbor_country", UncheckedTodo),
    (Scopes::State, "all_neighbor_state", UncheckedTodo),
    (Scopes::Country, "all_occupied_country", UncheckedTodo),
    (Scopes::None, "all_of", UncheckedTodo),
    (Scopes::None, "all_of_scopes", UncheckedTodo),
    (Scopes::Country.union(Scopes::Operation), "all_operative_leader", UncheckedTodo),
    (Scopes::None, "all_other_country", UncheckedTodo),
    (Scopes::Country, "all_owned_state", UncheckedTodo),
    (Scopes::Country, "all_purchase_contracts", UncheckedTodo),
    (Scopes::Country, "all_scientists", UncheckedTodo),
    (Scopes::None, "all_state", UncheckedTodo),
    (Scopes::Country, "all_subject_countries", UncheckedTodo),
    (Scopes::Country, "all_unit_leader", UncheckedTodo),
    ...
    (Scopes::None, "and", UncheckedTodo),
    (Scopes::Country, "any_claim", UncheckedTodo),
    (Scopes::State, "any_country_with_core", UncheckedTodo),
    (Scopes::Country, "any_guaranteed_country", UncheckedTodo),
    (Scopes::Country, "any_home_area_neighbor_country", UncheckedTodo),
    (Scopes::None, "any_of", UncheckedTodo),
    (Scopes::None, "any_of_scopes", UncheckedTodo),
    (Scopes::Country.union(Scopes::Operation), "any_operative_leader", UncheckedTodo),
    (Scopes::State, "any_province_building_level", UncheckedTodo),
    (Scopes::None, "any_state_in", UncheckedTodo),
    (Scopes::Country, "any_war_score", UncheckedTodo),
    ...
    (Scopes::State, "compliance", UncheckedTodo),
    ...
    (Scopes::None, "date", UncheckedTodo),
    ...
    (Scopes::None, "difficulty", UncheckedTodo),
    ...
    (Scopes::Character, "has_character_flag", UncheckedTodo),
    ...
    (Scopes::Country, "has_country_flag", UncheckedTodo),
    ...
    (Scopes::None, "has_global_flag", UncheckedTodo),
    ...
    (Scopes::Country, "has_legitimacy", UncheckedTodo),
    (Scopes::Country, "has_license", UncheckedTodo),
    (Scopes::Country, "has_manpower", UncheckedTodo),
    ...
    (Scopes::IndustrialOrg, "has_mio_flag", UncheckedTodo),
    ...
    (Scopes::SpecialProject, "has_project_flag", UncheckedTodo),
    ...
    (Scopes::None, "has_start_date", UncheckedTodo),
    (Scopes::State, "has_state_category", UncheckedTodo),
    (Scopes::State, "has_state_flag", UncheckedTodo),
    ...
    (Scopes::Character, "has_unit_leader_flag", UncheckedTodo),
    ...
    (Scopes::Character, "not_already_hired_except_as", UncheckedTodo),
    (Scopes::Country, "num_battalions_in_states", UncheckedTodo),
    (Scopes::Country, "num_divisions", UncheckedTodo),
    (Scopes::Country, "num_divisions_in_states", UncheckedTodo),
    (Scopes::Country, "num_faction_members", UncheckedTodo),
    (Scopes::Country, "num_fake_intel_divisions", UncheckedTodo),
    (Scopes::Country, "num_finished_operations", UncheckedTodo),
    (Scopes::Country, "num_free_operative_slots", UncheckedTodo),
    (Scopes::Country, "num_nukes_being_dropped", UncheckedTodo),
    (Scopes::Country, "num_nukes_left_to_drop", UncheckedTodo),
    (Scopes::Country, "num_occupied_states", UncheckedTodo),
    (Scopes::Country, "num_of_available_civilian_factories", UncheckedTodo),
    (Scopes::Country, "num_of_available_military_factories", UncheckedTodo),
    (Scopes::Country, "num_of_available_naval_factories", UncheckedTodo),
    (Scopes::None, "num_of_career_profile_points", UncheckedTodo),
    (Scopes::Country, "num_of_civilian_factories", UncheckedTodo),
    (Scopes::Country, "num_of_civilian_factories_available_for_projects", UncheckedTodo),
    (Scopes::Country, "num_of_controlled_factories", UncheckedTodo),
    (Scopes::Country, "num_of_controlled_states", UncheckedTodo),
    (Scopes::Country, "num_of_factories", UncheckedTodo),
    (Scopes::Country, "num_of_military_factories", UncheckedTodo),
    (Scopes::Country, "num_of_naval_factories", UncheckedTodo),
    (Scopes::Country, "num_of_nukes", UncheckedTodo),
    (Scopes::Country, "num_of_operatives", UncheckedTodo),
    (Scopes::Country, "num_of_owned_factories", UncheckedTodo),
    (Scopes::Country, "num_of_supply_nodes", UncheckedTodo),
    (Scopes::Country, "num_operative_slots", UncheckedTodo),
    (Scopes::State, "num_owned_neighbour_states", UncheckedTodo),
    (Scopes::Country, "num_planes_stationed_in_regions", UncheckedTodo),
    (Scopes::Country, "num_researched_technologies", UncheckedTodo),
    (Scopes::Country, "num_subjects", UncheckedTodo),
    (Scopes::Country, "num_tech_sharing_groups", UncheckedTodo),
    (Scopes::Character, "num_units", UncheckedTodo),
    ...
    (Scopes::State, "resistance", UncheckedTodo),
    ...
    (Scopes::Country, "surrender_progress", UncheckedTodo),
