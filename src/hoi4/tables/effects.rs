...
const SCOPE_EFFECT: &[(Scopes, &str, Effect)] = &[
    ...
    (Scopes::Character, "add_attack", Integer),
    ...
    (Scopes::Country, "add_cic", Integer),
    (Scopes::Country, "add_civil_war_target", UncheckedTodo),
    (Scopes::State, "add_claim_by", Scope(Scopes::Country)),
    (Scopes::Country, "add_collaboration", UncheckedTodo),
    (Scopes::Country, "add_command_power", UncheckedTodo),
    (Scopes::State, "add_compliance", Integer),
    // TODO: check that inscope and outscope are different
    (
        Scopes::State.union(Scopes::Country),
        "add_contested_owner",
        Scope(Scopes::State.union(Scopes::Country)),
    ),
    (Scopes::Character, "add_coordination", Integer),
    (Scopes::State, "add_core_of", Scope(Scopes::Country)),
    ...
    (Scopes::Character, "add_defense", Integer),
    ...
    (Scopes::PurchaseContract, "cancel_purchase_contract", Yes),
    (Scopes::State, "cancel_resistance", Yes),
    ...
    (Scopes::Country, "drop_cosmetic_tag", Yes),
    (Scopes::None, "effect_tooltip", UncheckedTodo),
    (Scopes::None, "else", Control),
    (Scopes::None, "else_if", Control),
    (Scopes::Country, "end_exile", Scope(Scopes::Country)),
    (Scopes::Country, "end_puppet", Scope(Scopes::Country)),
    (Scopes::None, "event_option_tooltip", Item(Item::Localization)),
    ...
    (Scopes::State, "remove_claim_by", Scope(Scopes::Country)),
    // TODO: verify inscope and outscope are different
    (
        Scopes::State.union(Scopes::Country),
        "remove_contested_owner",
        Scope(Scopes::State.union(Scopes::Country)),
    ),
    (Scopes::State, "remove_core_of", Scope(Scopes::Country)),
    ...
    (Scopes::Country, "unlock_national_focus", Item(Item::NationalFocus)),
