...
const SCOPE_EFFECT: &[(Scopes, &str, Effect)] = &[
    ...
    (Scopes::Character, "change_mercenary_employer", ScopeOrItem(Scopes::Country, Item::Localization)),
    ...
    (Scopes::Character, "move_country_with_message", ScopeOrItem(Scopes::Country, Item::Localization)),
    ...
    (Scopes::Treasure, "transfer_treasure_to_country", ScopeOrItem(Scopes::Country, Item::Localization)),
