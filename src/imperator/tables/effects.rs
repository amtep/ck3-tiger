...
const SCOPE_EFFECT: &[(Scopes, &str, Effect)] = &[
    ...
    (Scopes::all_but_none(), "add_to_list", Vv(validate_add_to_list_imperator)),
    (Scopes::None, "add_to_local_variable_list", Vb(validate_add_to_variable_list)),
    (Scopes::all_but_none(), "add_to_temporary_list", Vv(validate_add_to_list_imperator)),
    ...
    (Scopes::None, "remove_global_variable", Identifier("list name")),
