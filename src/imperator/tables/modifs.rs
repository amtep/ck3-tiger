...
const MODIF_TABLE: &[(&str, ModifKinds)] = &[
    ...
    ("max_rivals", ModifKinds::Character.union(ModifKinds::Country)),
    ("max_friends", ModifKinds::Character.union(ModifKinds::Country)),
    ...
    ("barbarian_spawn_chance", ModifKinds::Province.union(ModifKinds::State)),
