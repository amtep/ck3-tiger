...
const TRIGGER: &[(Scopes, &str, Trigger)] = &[
    ...
    (Scopes::GreatWork, "great_work_builder", Scope(Country)),
    ...
    (Scopes::Character, "has_culture", Scope(Culture) | Item(Item::Culture)),
    (Scopes::Character, "has_culture_group", Scope(Culture) | Item(Item::Culture)),
    (Scopes::Character, "has_father", Boolean),
    (Scopes::Character, "has_holding_in", Scope(Province)),
    ...
    (Scopes::Character, "has_religion", Scope(Religion) | Item(Item::Religion)),
    (Scopes::Character, "has_same_culture_group_as", Scope(Character)),
    (Scopes::Character, "has_same_family", Scope(Character)),
    (Scopes::Character, "has_same_religion_as", Scope(Character)),
    ...
    (Scopes::Character, "is_at_location", Scope(Province)),
    (Scopes::Character, "is_at_same_location", Scope(Character)),
    (Scopes::Character, "is_banished", Boolean),
    (Scopes::Character, "is_bastard", Boolean),
    (Scopes::Character, "is_child_of", Scope(Character)),
    (Scopes::Character, "is_clan_chief", Boolean),
    (Scopes::Character, "is_close_relative", Scope(Character)),
    ...
    (Scopes::Character, "is_friend", Scope(Character)),
    ...
    (Scopes::Character, "is_parent_of", Scope(Character)),
    ...
    (Scopes::Character, "is_rival", Scope(Character)),
    (Scopes::Character, "is_ruler", Boolean),
    (Scopes::Character, "is_same_gender", Scope(Character)),
    (Scopes::Character, "is_same_party_as", Scope(Character)),
    (Scopes::Character, "is_sibling_of", Scope(Character)),
    (Scopes::Character, "is_spouse_of", Scope(Character)),
    ...
    (Scopes::Character, "party", Scope(Party)),
    ...
    (Scopes::Pop, "pop_culture", Scope(Culture) | Item(Item::Culture)),
    (Scopes::Pop, "pop_culture_group", Scope(CultureGroup) | Item(Item::CultureGroup)),
    (Scopes::Pop, "pop_hapiness", CompareValue),
    (Scopes::Pop, "pop_religion", Scope(Religion) | Item(Item::CultureGroup)),
    ...
    (Scopes::Country, "alliance_with", Scope(Country)),
    (Scopes::Country, "biggest_party", Scope(Party) | Item(Item::PartyType)),
    (Scopes::Country, "alliance_with", Scope(Country)),
    ...
    (Scopes::Country, "civil_war_with", Scope(Country)),
    ...
    (Scopes::Country, "exports_to", Scope(Country)),
    ...
    (Scopes::Country, "has_deity_in_pantheon", Scope(Deity)),
    ...
    (Scopes::Country, "has_military_access", Scope(Country)),
    ...
    (Scopes::Country, "has_opinion", Block(&[("modifier", Item(Item::Opinion)), ("target", Scope(Country))])),
    ...
    (Scopes::Country, "has_this_omen", Scope(Deity) | Item(Item::Deity)),
    (Scopes::Country, "has_truce_with", Scope(Country)),
    ...
    (Scopes::Country, "imports_from", Scope(Country)),
    (Scopes::Country, "in_diplomatic_range", Scope(Country)),
    (Scopes::Country, "invention", Item(Item::Invention)),
    (Scopes::Country, "is_ai", Boolean),
    (Scopes::Country, "is_antagonist", Boolean),
    (Scopes::Country, "is_guaranteed_by", Scope(Country)),
    (Scopes::Country, "is_monarchy", Boolean),
    (Scopes::Country, "is_monotheist_deity", Scope(Deity)),
    (Scopes::Country, "is_republic", Boolean),
    (Scopes::Country, "is_subject", Boolean),
    (Scopes::Country, "is_subject_of", Scope(Country)),
    ...
    (Scopes::Country, "opinion", Block(&[("type", Scope(Country)), ("value", CompareValue)])),
    (Scopes::Country, "owns", Scope(Province) | CompareValue),
    (Scopes::Country, "owns_area", Scope(Area) | Item(Item::Area)),
    (Scopes::Country, "owns_or_subject_owns", Scope(Province) | CompareValue),
    (Scopes::Country, "owns_or_subject_owns_area", Scope(Area) | Item(Item::Area)),
    (Scopes::Country, "owns_or_subject_owns_region", Scope(Region) | Item(Item::Region)),
    (Scopes::Country, "owns_region", Scope(Region) | Item(Item::Region)),
    ...
    (Scopes::Country, "primary_culture", Item(Item::Culture) | Scope(Culture)),
    (Scopes::Country, "rank", CompareValue),
    (Scopes::Country, "religion", Item(Item::Religion) | Scope(Religion)),
    (Scopes::Country, "religious_unity", CompareValue),
    (Scopes::Country, "safety", CompareValue),
    (Scopes::Country, "stability", CompareValue),
    (Scopes::Country, "tag", Scope(Country)),
    ...
    (Scopes::Country, "war_with", Scope(Country)),
    (Scopes::Country, "culture_pops_in_country", Block(&[("target", Scope(CountryCulture)), ("value", CompareValue)])),
    ...
    (Scopes::War, "is_war_leader", Scope(Country)),
    (Scopes::War, "is_war_over", Boolean),
    (Scopes::War, "war_score", Block(&[("target", Scope(Country)), ("value", CompareValue)])),
    // Deity triggers
    (Scopes::Deity, "deity_religion", Item(Item::Religion) | Scope(Religion)),
    ...
    // Province triggers
    (Scopes::Province, "ai_wants_road", Scope(Country)),
    ...
    (Scopes::Province, "control_range", Scope(Country)),
    (Scopes::Province, "distance_to_migration_target", CompareValue),
    (Scopes::Province, "dominant_province_culture", Item(Item::Culture) | Scope(Culture)),
    (Scopes::Province, "dominant_province_religion", Item(Item::Religion) | Scope(Religion)),
    ...
    (Scopes::Province, "has_enemy_army", Scope(Country)),
    (Scopes::Province, "has_enemy_navy", Scope(Country)),
    ...
    (Scopes::Province, "has_road_towards", Scope(Country)),
    ...
    (Scopes::Province, "is_colonizer", Scope(Country)),
    (Scopes::Province, "is_core_of", Scope(Country)),
    (Scopes::Province, "is_holy_site", Boolean),
    (Scopes::Province, "is_importing_trade_good", Item(Item::TradeGood)),
    (Scopes::Province, "is_in_area", Item(Item::Area)) | Scope(Area),
    (Scopes::Province, "is_in_region", Item(Item::Region) | Scope(Region)),
    (Scopes::Province, "is_inhabitable", Boolean),
    (Scopes::Province, "is_model_shown", UncheckedValue),
    (Scopes::Province, "is_neighbor", Scope(Province)),    
    (Scopes::Province, "is_port", Boolean),
    (Scopes::Province, "is_previous_controller", Scope(Country)),
    (Scopes::Province, "is_previous_owner", Scope(Country)),
    ...
    (Scopes::Province, "owned_or_subject_owned", Scope(Country)),
    ...
    (Scopes::CountryCulture, "has_pop_type_right", Item(Item::Culture) | Scope(Culture)),
    ...
    (Scopes::None, "is_target_alive", Scope(Character)),
    (Scopes::
        None,
    ...
    (Scopes::None, "religion_pops_in_country", Block(&[("target", Scope(Religion) | Item(Item::Religion)), ("value", CompareValue)])),
    (Scopes::all_but_none(), "save_temporary_scope_as", Special),
    (Scopes::None, "switch", Special),
    (Scopes::None, "target_is_valid_character", Scope(Character)),
