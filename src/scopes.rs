...
bitflags! {
    ...
    pub struct Scopes: u64 {
        ...
        #[cfg(feature = "ck3")] const Decision = 0x1000_0000;
        #[cfg(feature = "ck3")] const Doctrine = 0x2000_0000;
        #[cfg(feature = "ck3")] const Dynasty = 0x4000_0000;
        #[cfg(feature = "ck3")] const DynastyHouse = 0x8000_0000;
        #[cfg(feature = "ck3")] const Faction = 0x0000_0001_0000_0000;
        #[cfg(feature = "ck3")] const Faith = 0x0000_0002_0000_0000;
        #[cfg(feature = "ck3")] const GovernmentType = 0x0000_0004_0000_0000;
        #[cfg(feature = "ck3")] const GreatHolyWar = 0x0000_0008_0000_0000;
        #[cfg(feature = "ck3")] const HolyOrder = 0x0000_0010_0000_0000;
        #[cfg(feature = "ck3")] const Inspiration = 0x0000_0020_0000_0000;
        #[cfg(feature = "ck3")] const LandedTitle = 0x0000_0040_0000_0000;
        #[cfg(feature = "ck3")] const MercenaryCompany = 0x0000_0080_0000_0000;
        #[cfg(feature = "ck3")] const Scheme = 0x0000_0100_0000_0000;
        #[cfg(feature = "ck3")] const Secret = 0x0000_0200_0000_0000;
        #[cfg(feature = "ck3")] const StoryCycle = 0x0000_0400_0000_0000;
        #[cfg(feature = "ck3")] const Struggle = 0x0000_0800_0000_0000;
        #[cfg(feature = "ck3")] const TitleAndVassalChange = 0x0000_1000_0000_0000;
        #[cfg(feature = "ck3")] const Trait = 0x0000_2000_0000_0000;
        #[cfg(feature = "ck3")] const TravelPlan = 0x0000_4000_0000_0000;
        #[cfg(feature = "ck3")] const VassalContract = 0x0000_8000_0000_0000;
        #[cfg(feature = "ck3")] const VassalObligationLevel = 0x0001_0000_0000_0000;
