...
const MODIF_TABLE: &[(&str, ModifKinds)] = &[
    ...
    ("monthly_piety_gain_per_legitimacy_add", ModifKinds::Character),
    ("monthly_piety_gain_per_legitimacy_mult", ModifKinds::Character),
    ...
    ("monthly_prestige_gain_per_legitimacy_add", ModifKinds::Character),
    ("monthly_prestige_gain_per_legitimacy_mult", ModifKinds::Character),
