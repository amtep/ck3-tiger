&[
    ...
    ("CONFEDERATION", Args::Args(&[]), Ck3(Confederation)),
    ...
    ("GetSituation", Args::Args(&[DType(Unknown)]), Ck3(Situation)),
    ...
    ("SITUATION", Args::Args(&[]), Ck3(Situation)),
    ("SITUATION_CATALYST_TYPE", Args::Args(&[]), Ck3(SituationCatalystType)),
    ("SITUATION_PARTICIPANT_GROUP", Args::Args(&[]), Ck3(SituationParticipantGroup)),
    ("SITUATION_PHASE_TYPE", Args::Args(&[]), Ck3(SituationPhaseType)),
    ("SITUATION_SUB_REGION", Args::Args(&[]), Ck3(SituationSubRegion)),
    ("SITUATION_TYPE", Args::Args(&[]), Ck3(SituationType)),
    ("STRUGGLE", Args::Args(&[]), Ck3(Struggle)),
    ("STRUGGLE_TYPE", Args::Args(&[]), Ck3(StruggleType)),
    ("TARGET_ARMY", Args::Args(&[]), Ck3(Army)),
    ("TARGET_BUILDING", Args::Args(&[]), Ck3(Building)),
    ...
    ("TARGET_HOLDING_TYPE", Args::Args(&[]), Ck3(HoldingType)),
    ...
    ("VASSAL_CONTRACT_TYPE", Args::Args(&[]), Ck3(SubjectContractType)),
