...
const SCOPE_EFFECT: &[(u64, &str, Effect)] = &[
    ...
    (Character, "accept_activity_invite_without_travel", Scope(Scopes::Activity)),
    (Activity, "accept_invitation_for_character", Scope(Scopes::Character)),
    (Accolade, "activate_accolade", Yes),
    (Faith, "activate_holy_site", Item(Item::HolySite)),
    (Struggle, "activate_struggle_catalyst", VBv(EvBv::ActivateStruggleCatalyst)),
    (Activity, "add_activity_log_entry", VB(EvB::AddActivityLogEntry)),
    (Character, "add_amenity_level", ItemValue("type", Item::Amenity)),
    (Artifact, "add_artifact_history", VB(EvB::AddArtifactHistory)),
    (Artifact, "add_artifact_modifier", VV(EvV::AddArtifactModifier)),
    (Artifact, "add_artifact_title_history", VB(EvB::AddArtifactTitleHistory)),
    (War, "add_attacker", Scope(Scopes::Character)),
    (Province, "add_building", Item(Item::Building)),
    (ALL, "add_building_slot", Removed("1.9", "replaced by the `extra_building_slot` modifier")),
    ...
    (Culture, "add_culture_tradition", Item(Item::CultureTradition)),
    ...
    (CasusBelli, "add_from_contribution_attackers", VB(EvB::AddFromContribution)),
    (CasusBelli, "add_from_contribution_defenders", VB(EvB::AddFromContribution)),
    ...
    (DynastyHouse, "add_house_artifact_claim", Scope(Scopes::Artifact)),
    ...
    (Character, "add_personal_artifact_claim", Scope(Scopes::Artifact)),
    ...
    (Culture, "add_random_valid_tradition", Scope(Scopes::Character)),
    (Culture, "add_random_valid_tradition_replace_if_necessary", Scope(Scopes::Character)),
    ...
    (Province, "add_special_building", Item(Item::SpecialBuilding)),
    (Province, "add_special_building_slot", Item(Item::SpecialBuilding)),
    ...
    (Character, "add_to_activity_without_travel", Scope(Scopes::Activity)),
    ...
    (Character, "add_trait", ScopeOrItem(Scopes::Trait, Item::Trait)),
    (Character, "add_trait_force_tooltip", ScopeOrItem(Scopes::Trait, Item::Trait)),
    ...
    (Province, "add_travel_point_of_interest", Item(Item::PointOfInterest)),
    ...
    (Character, "apply_ai_vassal_obligation_liege_most_desired", Yes),
    (Character, "apply_ai_vassal_obligation_vassal_most_desired", Yes),
    (
        Character,
    ...
    (Character, "assign_councillor_type", VB(EvB::AssignCouncillorType)),
    (Character, "banish", Yes),
    (CombatSide, "battle_event", VB(EvB::BattleEvent)),
    (Character, "becomes_independent", Target("change", Scopes::TitleAndVassalChange)),
    (Province, "begin_create_holding", VBv(EvBv::BeginCreateHolding)),
    ...
    (Character, "cancel_truce_both_ways", Scope(Scopes::Character)),
    ...
    (Culture, "change_cultural_acceptance", VB(EvB::ChangeCulturalAcceptance)),
    ...
    (LandedTitle, "change_development_progress_with_overflow", ScriptValue),
    ...
    (LandedTitle, "change_title_holder", VB(EvB::ChangeTitleHolder)),
    (LandedTitle, "change_title_holder_include_vassals", VB(EvB::ChangeTitleHolder)),
    ...
    (Character, "consume_banish_reasons", Scope(Scopes::Character)),
    (Character, "consume_divorce_reasons", Scope(Scopes::Character)),
    (Character, "consume_execute_reasons", Scope(Scopes::Character)),
    (Character, "consume_imprisonment_reasons", Scope(Scopes::Character)),
    (Character, "consume_revoke_title_reason", Scope(Scopes::Character)),
    (Culture, "copy_all_traditions_from", Scope(Scopes::Culture)),
    (Artifact, "copy_artifact_modifiers", Scope(Scopes::Artifact)),
    (Character, "copy_inheritable_appearance_from", Scope(Scopes::Character)),
    (Character, "copy_localized_text", VB(EvB::CopyLocalizedText)),
    (LandedTitle, "copy_title_history", Scope(Scopes::LandedTitle)),
    ...
    (Character, "create_betrothal_matrilineal", Scope(Scopes::Character)),
    (Character, "create_cadet_branch", Yes),
    (None, "create_character", VB(EvB::CreateCharacter)),
    (Character, "create_character_memory", VB(EvB::CreateCharacterMemory)),
    (Character, "create_divergent_culture", Yes),
    (Character, "create_divergent_culture_with_side_effects", Yes),
    (Character, "create_divergent_culture_with_side_effects_excluding_cost", Yes),
    (None, "create_dynamic_title", VB(EvB::CreateDynamicTitle)),
    (Character, "create_faction", ItemTarget("type", Item::Faction, "target", Scopes::Character)),
    (None, "create_holy_order", VB(EvB::CreateHolyOrder)),
    (Character, "create_hybrid_culture", Scope(Scopes::Culture)),
    (Character, "create_hybrid_culture_with_side_effects", Scope(Scopes::Culture)),
    (Character, "create_inspiration", VBv(EvBv::CreateInspiration)),
    (Character, "create_story", VBv(EvBv::CreateStory)),
    (None, "create_title_and_vassal_change", VB(EvB::CreateTitleAndVassalChange)),
    ...
    (Character, "decline_activity_invite", Scope(Scopes::Activity)),
    (
        ALL,
        "decline_invitation_for_character",
        Removed("1.9", "replaced by `decline_activity_invite`"),
    ),
    (Character, "decline_invitation_for_character", Scope(Scopes::Activity)),
    ...
    (None, "destroy_character_memory", Scope(Scopes::CharacterMemory)),
    ...
    (GreatHolyWar, "do_ghw_title_handout", Scope(Scopes::TitleAndVassalChange)),
    (Character, "duel", VB(EvB::Duel)),
    (None, "else", Control),
    (None, "else_if", Control),
    (Character, "end_diarchy", Boolean),
    (Character, "end_inspiration_sponsorship", Scope(Scopes::Inspiration)),
    ...
    (War, "end_war", Choice(&["attacker", "defender", "white_peace", "invalidated"])),
    ...
    (LandedTitle | Dynasty | DynastyHouse, "generate_coa", VV(EvV::GenerateCoa)),
    (Culture, "get_all_innovations_from", Scope(Scopes::Culture)),
    (Culture, "get_random_innovation_from", Scope(Scopes::Culture)),
    (Character, "get_title", Scope(Scopes::LandedTitle)),
    (Character, "give_nickname", Item(Item::Nickname)),
    (None, "hidden_effect", Control),
    (None, "hidden_effect_new_artifact", Removed("1.9", "replaced by `hidden_effect_new_object`")),
    ...
    (Character, "learn_court_language_of", ScopeOkThis(Scopes::Character)),
    (Character, "learn_language", Item(Item::Language)),
    (Character, "learn_language_of_culture", Scope(Scopes::Culture)),
    ...
    (Character, "make_trait_active", ScopeOrItem(Scopes::Trait, Item::Trait)),
    (Character, "make_trait_active_force_tooltip", ScopeOrItem(Scopes::Trait, Item::Trait)),
    (Character, "make_trait_inactive", ScopeOrItem(Scopes::Trait, Item::Trait)),
    (Character, "make_trait_inactive_force_tooltip", ScopeOrItem(Scopes::Trait, Item::Trait)),
    ...
    (Character, "open_appoint_court_position_window", Item(Item::CourtPosition)),
    (None, "open_interaction_window", VB(EvB::OpenInteractionWindow)),
    ...
    (ALL, "recruit_courtier", Removed("1.9.1", "replaced by `add_courtier`")),
    ...
    (Character, "remove_all_character_modifier_instances", Item(Item::Modifier)),
    (LandedTitle, "remove_all_county_modifier_instances", Item(Item::Modifier)),
    (Dynasty, "remove_all_dynasty_modifier_instances", Item(Item::Modifier)),
    (DynastyHouse, "remove_all_house_modifier_instances", Item(Item::Modifier)),
    (Province, "remove_all_province_modifier_instances", Item(Item::Modifier)),
    (TravelPlan, "remove_all_travel_plan_modifier_instances", Item(Item::Modifier)),
    (Artifact, "remove_artifact_feature_group", Item(Item::ArtifactFeatureGroup)),
    ...
    (Character, "remove_courtier_or_guest", VBv(EvBv::RemoveCourtierOrGuest)),
    (Culture, "remove_culture_tradition", Item(Item::CultureTradition)),
    ...
    (Activity, "remove_from_guest_subset", VB(EvB::RemoveFromGuestSubset)),
    (ALL_BUT_NONE, "remove_from_list", VV(EvV::RemoveFromList)),
    (None, "remove_global_variable", Unchecked),
    (Province, "remove_holding", Yes),
    (Character, "remove_hook", ItemTarget("type", Item::Hook, "target", Scopes::Character)),
    (DynastyHouse, "remove_house_artifact_claim", Scope(Scopes::Artifact)),
    (DynastyHouse, "remove_house_modifier", Item(Item::Modifier)),
    (Culture, "remove_innovation", Item(Item::Innovation)),
    (Character, "remove_interaction_cooldown", Item(Item::Interaction)),
    (
        Character,
    ...
    (Character, "remove_personal_artifact_claim", Scope(Scopes::Artifact)),
    ...
    (Character, "remove_trait", ScopeOrItem(Scopes::Trait, Item::Trait)),
    (Character, "remove_trait_force_tooltip", ScopeOrItem(Scopes::Trait, Item::Trait)),
    (TravelPlan, "remove_travel_option", Item(Item::TravelOption)),
    (TravelPlan, "remove_travel_plan_modifier", Item(Item::Modifier)),
    (Province, "remove_travel_point_of_interest", Item(Item::PointOfInterest)),
    (None, "remove_variable", Unchecked),
    (Character, "remove_war_chest_gold", NonNegativeValue),
    (Character, "replace_court_position", VB(EvB::ReplaceCourtPosition)),
    ...
    (None, "resolve_title_and_vassal_change", Scope(Scopes::TitleAndVassalChange)),
    ...
    (Character, "revoke_court_position", VB(EvB::RevokeCourtPosition)),
    ...
    (Character, "set_amenity_level", ItemValue("type", Item::Amenity)),
    (Army, "set_army_location", Scope(Scopes::Province)),
    (Artifact, "set_artifact_description", Desc),
    (Artifact, "set_artifact_feature", Item(Item::ArtifactFeature)),
    (Artifact, "set_artifact_feature_group", Item(Item::ArtifactFeatureGroup)),
    ...
    (LandedTitle, "set_capital_county", Scope(Scopes::LandedTitle)),
    (War, "set_casus_belli", Item(Item::CasusBelli)),
    (Character, "set_character_faith", Scope(Scopes::Faith)),
    (Character, "set_character_faith_history", Scope(Scopes::Faith)),
    (Character, "set_character_faith_with_conversion", Scope(Scopes::Faith)),
    (Character, "set_child_of_concubine_on_pregnancy", Boolean),
    (LandedTitle | Dynasty | DynastyHouse, "set_coa", VV(EvV::SetCoa)),
    (LandedTitle, "set_color_from_title", Scope(Scopes::LandedTitle)),
    ...
    (Culture, "set_cultural_acceptance", TargetValue("target", Scopes::Culture, "value")),
    (Character, "set_culture", Scope(Scopes::Culture)),
    (Struggle, "set_culture_as_involved", Scope(Scopes::Culture)),
    (Struggle, "set_culture_as_uninvolved", Scope(Scopes::Culture)),
    ...
    (LandedTitle, "set_de_jure_liege_title", Scope(Scopes::LandedTitle)),
    ...
    (GreatHolyWar, "set_designated_winner", Scope(Scopes::Character)),
    ...
    (GreatHolyWar, "set_great_holy_war_target", VB(EvB::SetGHWTarget)),
    ...
    (DynastyHouse, "set_house_name_from_dynasty", Scope(Scopes::Dynasty)),
    (DynastyHouse, "set_house_name_from_house", Scope(Scopes::DynastyHouse)),
    (Character, "set_immortal_age", ScriptValue),
    (Character, "set_killer_public", Boolean),
    (Character, "set_knight_status", Choice(&["force", "forbid", "default", "allow"])),
    ...
    (Character, "set_pregnancy_assumed_father", Scope(Scopes::Character)),
    (Character, "set_pregnancy_gender", Choice(&["male", "female", "random"])),
    (Character, "set_primary_spouse", Scope(Scopes::Character)),
    (Character, "set_primary_title_to", Scope(Scopes::LandedTitle)),
    (Character, "set_real_father", Scope(Scopes::Character)),
    (Character, "set_realm_capital", Scope(Scopes::LandedTitle)),
    (Faith, "set_religious_head_title", Scope(Scopes::LandedTitle)),
    ...
    (TravelPlan, "set_travel_plan_owner", Scope(Scopes::Character)),
    (None, "set_variable", VBv(EvBv::SetVariable)),
    (Character, "set_vassal_contract_modification_blocked", Boolean),
    ...
    (None, "try_create_important_action", VB(EvB::TryCreateImportantAction)),
    (None, "try_create_suggestion", VB(EvB::TryCreateSuggestion)),
    (Artifact, "unequip_artifact_from_owner", Yes),
    (Character, "unlearn_court_language_of", ScopeOkThis(Scopes::Character)),
    (Character, "unlearn_language", Item(Item::Language)),
    (Character, "unlearn_language_of_culture", Scope(Scopes::Culture)),
    ...
    (Character, "vassal_contract_decrease_obligation_level", Item(Item::VassalContract)),
    (Character, "vassal_contract_increase_obligation_level", Item(Item::VassalContract)),
    (Character, "vassal_contract_set_obligation_level", VB(EvB::VassalContractSetObligationLevel)),
