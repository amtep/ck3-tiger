...
const SCOPE_EFFECT: &[(Scopes, &str, Effect)] = &[
    ...
    (Scopes::Struggle, "activate_struggle_catalyst", VBv(EvBv::ActivateStruggleCatalyst)),
    (Scopes::Activity, "add_activity_log_entry", VB(EvB::AddActivityLogEntry)),
    (Scopes::Character, "add_amenity_level", ItemValue("type", Item::Amenity)),
    (Scopes::Artifact, "add_artifact_history", VB(EvB::AddArtifactHistory)),
    (Scopes::Artifact, "add_artifact_modifier", VV(EvV::AddArtifactModifier)),
    (Scopes::Artifact, "add_artifact_title_history", VB(EvB::AddArtifactTitleHistory)),
    ...
    (Scopes::Character, "add_character_flag", VBv(EvBv::AddCharacterFlag)),
    (Scopes::Character, "add_character_modifier", AddModifier),
    (Scopes::TravelPlan, "add_companion", Scope(Scopes::Character)),
    (Scopes::LandedTitle, "add_county_modifier", AddModifier),
    ...
    (Scopes::Faith, "add_doctrine", Item(Item::Doctrine)),
    (Scopes::Character, "add_dread", ScriptValue),
    (Scopes::Artifact, "add_durability", ScriptValue),
    (Scopes::Dynasty, "add_dynasty_modifier", AddModifier),
    ...
    (Scopes::CasusBelli, "add_from_contribution_attackers", VB(EvB::AddFromContribution)),
    (Scopes::CasusBelli, "add_from_contribution_defenders", VB(EvB::AddFromContribution)),
    (Scopes::Accolade, "add_glory", ScriptValue),
    (Scopes::Character, "add_gold", NonNegativeValue),
    (Scopes::Character, "add_hook", VB(EvB::AddHook)),
    (Scopes::Character, "add_hook_no_toast", VB(EvB::AddHook)),
    (Scopes::DynastyHouse, "add_house_artifact_claim", Scope(Scopes::Artifact)),
    (Scopes::DynastyHouse, "add_house_modifier", AddModifier),
    ...
    (Scopes::Character, "add_opinion", VB(EvB::AddOpinion)),
    ...
    (Scopes::Province, "add_province_modifier", AddModifier),
    ...
    (Scopes::Character, "add_relation_flag", VB(EvB::AddRelationFlag)),
    (Scopes::Character, "add_reserved_gold", ScriptValue),
    (Scopes::Character, "add_scheme_cooldown", VB(EvB::AddSchemeCooldown)),
    (Scopes::Scheme, "add_scheme_modifier", VB(EvB::AddSchemeModifier)),
    (Scopes::Scheme, "add_scheme_progress", ScriptValue),
    (Scopes::Character, "add_secret", VB(EvB::AddSecret)),
    ...
    (Scopes::Activity, "add_to_guest_subset", VB(EvB::AddToGuestSubset)),
    ...
    (Scopes::Character, "add_trait_xp", VB(EvB::AddTraitXp)),
    (Scopes::Character, "add_travel_option", Item(Item::TravelOption)),
    (Scopes::TravelPlan, "add_travel_plan_modifier", AddModifier),
    ...
    (Scopes::Character, "add_truce_both_ways", VB(EvB::AddTruce)),
    (Scopes::Character, "add_truce_one_way", VB(EvB::AddTruce)),
    ...
    (Scopes::Character, "assign_council_task", VB(EvB::AssignCouncilTask)),
    (Scopes::Character, "assign_councillor_type", VB(EvB::AssignCouncillorType)),
    (Scopes::Character, "banish", Yes),
    (Scopes::CombatSide, "battle_event", VB(EvB::BattleEvent)),
    (Scopes::Character, "becomes_independent", Target("change", Scopes::TitleAndVassalChange)),
    (Scopes::Province, "begin_create_holding", VBv(EvBv::BeginCreateHolding)),
    ...
    (Scopes::Culture, "change_cultural_acceptance", VB(EvB::ChangeCulturalAcceptance)),
    ...
    (Scopes::Character, "change_first_name", VBv(EvBv::ChangeFirstName)),
    ...
    (Scopes::Character, "change_liege", VB(EvB::ChangeLiege)),
    ...
    (Scopes::LandedTitle, "change_title_holder", VB(EvB::ChangeTitleHolder)),
    (Scopes::LandedTitle, "change_title_holder_include_vassals", VB(EvB::ChangeTitleHolder)),
    (Scopes::Character, "change_trait_rank", VB(EvB::ChangeTraitRank)),
    ...
    (Scopes::None, "close_view", VBv(EvBv::CloseView)),
    ...
    (Scopes::Character, "copy_localized_text", VB(EvB::CopyLocalizedText)),
    (Scopes::LandedTitle, "copy_title_history", Scope(Scopes::LandedTitle)),
    (Scopes::Character, "copy_traits", Scope(Scopes::Character)),
    (Scopes::None, "create_accolade", VB(EvB::CreateAccolade)),
    (Scopes::Character, "create_alliance", VBv(EvBv::CreateAlliance)),
    (Scopes::Character, "create_artifact", VB(EvB::CreateArtifact)),
    ...
    (Scopes::None, "create_character", VB(EvB::CreateCharacter)),
    (Scopes::Character, "create_character_memory", VB(EvB::CreateCharacterMemory)),
    ...
    (Scopes::None, "create_dynamic_title", VB(EvB::CreateDynamicTitle)),
    (
        Scopes::Character,
        "create_faction",
        ItemTarget("type", Item::Faction, "target", Scopes::Character),
    ),
    (Scopes::None, "create_holy_order", VB(EvB::CreateHolyOrder)),
    ...
    (Scopes::Character, "create_inspiration", VBv(EvBv::CreateInspiration)),
    (Scopes::Character, "create_story", VBv(EvBv::CreateStory)),
    (Scopes::None, "create_title_and_vassal_change", VB(EvB::CreateTitleAndVassalChange)),
    ...
    (Scopes::Character, "death", VBv(EvBv::Death)),
    ...
    (Scopes::TravelPlan, "delay_travel_plan", VB(EvB::DelayTravelPlan)),
    ...
    (Scopes::GreatHolyWar, "divide_war_chest", VB(EvB::DivideWarChest)),
    ...
    (Scopes::Character, "duel", VB(EvB::Duel)),
    ...
    (Scopes::Faction, "faction_start_war", VB(EvB::FactionStartWar)),
    ...
    (Scopes::Character, "force_add_to_scheme", VB(EvB::ForceAddToScheme)),
    (Scopes::Character, "force_character_skill_recalculation", Yes),
    (Scopes::Character, "force_vote_as", VB(EvB::ForceVoteAs)),
    ...
    (Scopes::Character, "imprison", VB(EvB::Imprison)),
    ...
    (Scopes::Character, "join_faction_forced", VB(EvB::JoinFactionForced)),
    ...
    (Scopes::Character, "make_pregnant", VB(EvB::MakePregnant)),
    (Scopes::Character, "make_pregnant_no_checks", VB(EvB::MakePregnant)),
    ...
    (Scopes::Character, "move_budget_gold", VB(EvB::MoveBudgetGold)),
    ...
    (Scopes::None, "open_interaction_window", VB(EvB::OpenInteractionWindow)),
    (Scopes::None, "open_view", VBv(EvBv::OpenView)),
    (Scopes::all_but_none(), "open_view_data", VBv(EvBv::OpenView)),
    ...
    (Scopes::Character, "pay_long_term_gold", VB(EvB::PayGold)),
    (Scopes::Character, "pay_long_term_income", VB(EvB::PayIncome)),
    (Scopes::Character, "pay_reserved_gold", VB(EvB::PayGold)),
    (Scopes::Character, "pay_reserved_income", VB(EvB::PayIncome)),
    (Scopes::Character, "pay_short_term_gold", VB(EvB::PayGold)),
    (Scopes::Character, "pay_short_term_income", VB(EvB::PayIncome)),
    (Scopes::Character, "pay_war_chest_gold", VB(EvB::PayGold)),
    (Scopes::Character, "pay_war_chest_income", VB(EvB::PayIncome)),
    ...
    (Scopes::Artifact, "reforge_artifact", VB(EvB::CreateArtifact)),
    ...
    (Scopes::Character, "remove_courtier_or_guest", VBv(EvBv::RemoveCourtierOrGuest)),
    ...
    (Scopes::Activity, "remove_from_guest_subset", VB(EvB::RemoveFromGuestSubset)),
    ...
    (Scopes::Character, "remove_opinion", VB(EvB::RemoveOpinion)),
    ...
    (Scopes::Character, "remove_relation_flag", VB(EvB::AddRelationFlag)),
    ...
    (Scopes::Character, "replace_court_position", VB(EvB::ReplaceCourtPosition)),
    ...
    (Scopes::Character, "reverse_add_opinion", VB(EvB::AddOpinion)),
    (Scopes::Character, "revoke_court_position", VB(EvB::RevokeCourtPosition)),
    ...
    (Scopes::None, "run_interaction", VB(EvB::OpenInteractionWindow)),
    (Scopes::Character, "save_opinion_value_as", VB(EvB::SaveOpinionValue)),
    (Scopes::all_but_none(), "save_scope_as", VV(EvV::SaveScope)),
    (Scopes::None, "save_scope_value_as", VB(EvB::SaveScopeValue)),
    (Scopes::Character, "save_temporary_opinion_value_as", VB(EvB::SaveOpinionValue)),
    (Scopes::all_but_none(), "save_temporary_scope_as", VV(EvV::SaveScope)),
    (Scopes::None, "save_temporary_scope_value_as", VB(EvB::SaveScopeValue)),
    (Scopes::all(), "scheme_freeze_days", Removed("1.9", "replaced by `scheme_freeze`")),
    (Scopes::Scheme, "scheme_freeze", VB(EvB::SchemeFreeze)),
    ...
    (Scopes::Character, "set_council_task", VB(EvB::SetCouncilTask)),
    ...
    (Scopes::Culture, "set_culture_name", VB(EvB::SetCultureName)),
    ...
    (Scopes::Character, "set_death_reason", VB(EvB::SetDeathReason)),
    ...
    (Scopes::Character, "set_focus", VV(EvV::SetFocus)),
    // set_focus_progress ??
    ...
    (Scopes::GreatHolyWar, "set_great_holy_war_target", VB(EvB::SetGHWTarget)),
    ...
    (Scopes::Character, "set_location", VBv(EvBv::SetLocation)),
    ...
    (Scopes::Artifact, "set_owner", VBv(EvBv::SetOwner)),
    ...
    (Scopes::LandedTitle, "set_title_name", VV(EvV::SetTitleName)),
    (Scopes::LandedTitle, "set_title_prefix", Item(Item::Localization)),
    (Scopes::Character, "set_to_lowborn", Yes),
    (Scopes::Character, "set_trait_rank", VB(EvB::ChangeTraitRank)),
    ...
    (Scopes::None, "setup_claim_cb", VB(EvB::SetupCb)),
    (Scopes::None, "setup_de_jure_cb", VB(EvB::SetupCb)),
    (Scopes::None, "setup_invasion_cb", VB(EvB::SetupCb)),
    (Scopes::None, "show_as_tooltip", Control),
    (Scopes::Activity, "skip_activity_phase", Boolean),
    (Scopes::all(), "spawn_activity", Removed("1.9", "")),
    (Scopes::Character, "spawn_army", VB(EvB::SpawnArmy)),
    ...
    (Scopes::Faith, "start_great_holy_war", VB(EvB::SetGHWTarget)),
    (Scopes::Character, "start_scheme", VB(EvB::StartScheme)),
    (Scopes::None, "start_struggle", VB(EvB::StartStruggle)),
    (Scopes::Character, "start_travel_plan", VB(EvB::StartTravelPlan)),
    (Scopes::None, "start_tutorial_lesson", Unchecked),
    (Scopes::Character, "start_war", VB(EvB::StartWar)),
    (Scopes::Character, "store_localized_text_in_death", Unchecked),
    (Scopes::Character, "stress_impact", VB(EvB::StressImpact)),
    ...
    (Scopes::None, "trigger_event", VBv(EvBv::TriggerEvent)),
    (Scopes::None, "try_create_important_action", VB(EvB::TryCreateImportantAction)),
    (Scopes::None, "try_create_suggestion", VB(EvB::TryCreateSuggestion)),
