...
const TRIGGER: &[(u64, &str, RawTrigger)] = &[
    ...
    (Character, "all_court_artifact_slots", Choice(&["empty", "full"])),
    (None, "all_false", Control),
    (Character, "all_inventory_artifact_slots", Choice(&["empty", "full"])),
    ...
    (Faction, "average_faction_opinion_not_powerful_vassal", CompareValue),
    (Faction, "average_faction_opinion_powerful_vassal", CompareValue),
    ...
    (LandedTitle | Province, "building_max_garrison", CompareValue),
    ...
    (Character, "can_add_hook", Block(&[("target", Scope(Character)), ("type", Item(Item::Hook))])),
    (Character, "can_arrive_in_time_to_activity_minimum", Scope(Activity)),
    ...
    (Character, "can_employ_court_position_type", Item(Item::CourtPosition)),
    (Character, "can_equip_artifact", Scope(Artifact)),
    (Character, "can_execute_decision", ScopeOrItem(Decision, Item::Decision)),
    (CouncilTask, "can_fire_position", Boolean),
    (Culture, "can_get_innovation_from", Scope(Culture)),
    (Character, "can_have_children", Boolean),
    (Character, "can_host_activity", ScopeOrItem(ActivityType, Item::ActivityType)),
    ...
    (Character, "character_has_commander_trait_scope_does_not", Scope(Character)),
    (Character, "character_is_land_realm_neighbor", Scope(Character)),
    ...
    (Faith, "controls_holy_site_with_flag", Item(Item::HolySiteFlag)),
    ...
    (Character, "court_grandeur_minimum_expected_level", CompareValue),
    (Character, "court_positions_currently_available", CompareValue),
    ...
    (LandedTitle, "development_towards_level_increase", CompareValue),
    ...
    (Character, "does_ai_liege_in_vassal_contract_desire_obligation_change", Boolean),
    (Character, "does_ai_vassal_in_vassal_contract_desire_obligation_change", Boolean),
    ...
    (Character, "domain_size_excluding_grace_period", CompareValue),
    ...
    (Character, "employs_court_position", Item(Item::CourtPosition)),
    ...
    (Character, "government_disallows", Choice(&["create_cadet_branches"])),
    (Character, "government_has_flag", Item(Item::GovernmentFlag)),
    (Accolade, "has_accolade_category", Item(Item::AccoladeCategory)),
    (Accolade, "has_accolade_parameter", Item(Item::AccoladeParameter)),
    ...
    (Activity, "has_activity_type", ScopeOrItem(ActivityType, Item::ActivityType)),
    (
        Culture,
        "has_all_innovations",
        Block(&[
    ...
    (Artifact, "has_artifact_feature", Item(Item::ArtifactFeature)),
    (Artifact, "has_artifact_feature_group", Item(Item::ArtifactFeatureGroup)),
    ...
    (Character, "has_character_modifier_duration_remaining", Item(Item::Modifier)),
    ...
    (
        ...
        ItemOrBlock(
            Item::ActivityIntent,
            &[("type", Item(Item::ActivityIntent)), ("?target", Scope(Character))],
        ),
    ),
    (Character, "has_completed_inspiration", Boolean),
    (Province, "has_construction_with_flag", Item(Item::BuildingFlag)),
    (Character, "has_council_position", Item(Item::CouncilPosition)),
    (
        Character,
    ...
    (LandedTitle, "has_county_modifier_duration_remaining", Item(Item::Modifier)),
    ...
    (Culture, "has_cultural_parameter", Item(Item::CultureParameter)),
    (Culture, "has_cultural_pillar", Item(Item::CulturePillar)),
    (Culture, "has_cultural_tradition", Item(Item::CultureTradition)),
    ...
    (Character, "has_diarchy_active_parameter", Item(Item::DiarchyParameter)),
    (Character, "has_diarchy_parameter", Item(Item::DiarchyParameter)),
    ...
    (Faith, "has_doctrine_parameter", Item(Item::DoctrineParameter)),
    ...
    (Dynasty, "has_dynasty_modifier_duration_remaining", Item(Item::Modifier)),
    ...
    (DynastyHouse, "has_house_modifier_duration_remaining", Item(Item::Modifier)),
    ...
    (CharacterMemory, "has_memory_category", Item(Item::MemoryCategory)),
    ...
    (LandedTitle, "has_order_of_succession", Choice(&["election"])),
    ...
    (Character, "has_pending_interaction_of_type", Item(Item::Interaction)),
    ...
    (
        ...
        ItemOrBlock(
            Item::ActivityPhase,
            &[("?type", Item(Item::ActivityPhase)), ("?location", Scope(Province))],
        ),
    ),
    (
        Activity,
    ...
    (Province, "has_province_modifier_duration_remaining", Item(Item::Modifier)),
    ...
    (Culture, "has_same_culture_martial_tradition", Scope(Culture)),
    ...
    (Character, "has_selected_mandate", Item(Item::DiarchyMandate)),
    ...
    (Province, "has_stationed_regiment_of_base_type", Item(Item::MenAtArmsBase)),
    ...
    (Struggle, "has_struggle_phase_parameter", Item(Item::StrugglePhaseParameter)),
    ...
    (Province, "has_travel_point_of_interest", Item(Item::PointOfInterest)),
    ...
    (Character, "important_action_is_valid_but_invisible", Item(Item::ImportantAction)),
    (Character, "important_action_is_visible", Item(Item::ImportantAction)),
    ...
    (Character, "is_activity_type_on_cooldown", Scope(ActivityType)),
    ...
    (Character, "is_causing_raid_hostility_towards", Scope(Character)),
    (
        Character,
    ...
    (
        ...
        Block(&[("recipient", ScopeOkThis(Character)), ("interaction", Item(Item::Interaction))]),
    ),
    (
        Character,
    ...
    (Character, "is_close_or_extended_family_of", Scope(Character)),
    ...
    (
        ...
        Block(&[("court_position", Item(Item::CourtPosition)), ("who", Scope(Character))]),
    ),
    ...
    (LandedTitle, "is_de_facto_liege_or_above_target", Scope(LandedTitle)),
    (LandedTitle, "is_de_jure_liege_or_above_target", Scope(LandedTitle)),
    (Character, "is_decision_on_cooldown", ScopeOrItem(Decision, Item::Decision)),
    ...
    (Character, "is_foreign_court_or_pool_guest_of", Scope(Character)),
    ...
    (Character, "is_in_the_same_court_as_or_guest", Scope(Character)),
    ...
    (Character, "is_performing_council_task", Item(Item::CouncilTask)),
    ...
    (
        Activity,
        "is_special_guest",
        ScopeOrBlock(Character, &[("target", Scope(Character)), ("type", Item(Item::GuestSubset))]),
    ),
    ...
    (LandedTitle, "is_target_of_council_task", Item(Item::CouncilTask)),
    ...
    (Character, "is_valid_for_event_debug_cooldown", Item(Item::Event)), // will not work in release mode
    (Character, "is_valid_successor_for_accolade", Scope(Accolade)),
    ...
    (
        Character,
        "join_scheme_chance",
        Block(&[("scheme", Scope(Scheme)), ("max", SetValue), ("min", SetValue)]),
    ),
    ...
    (MercenaryCompany, "mercenary_company_expiration_days", CompareValue),
    ...
    (Character, "monthly_character_income_long_term", CompareValueWarnEq),
    (Character, "monthly_character_income_reserved", CompareValueWarnEq),
    (Character, "monthly_character_income_short_term", CompareValueWarnEq),
    (Character, "monthly_character_income_war_chest", CompareValueWarnEq),
    ...
    (TravelPlan, "next_destination_arrival_days", CompareValueWarnEq),
    ...
    (Character, "scriptedtests_can_marry_character", Scope(Character)),
    (Character, "scriptedtests_dread_base", CompareValue),
    (Character, "scriptedtests_gold_income_no_theocracy", CompareValue),
    ...
    (Character, "should_decision_create_alert", ScopeOrItem(Decision, Item::Decision)),
    (Character, "should_notify_can_host_activity", ScopeOrItem(ActivityType, Item::ActivityType)),
    (
        Character,
    ...
    (LandedTitle, "target_is_de_facto_liege_or_above", Scope(LandedTitle)),
    (LandedTitle, "target_is_de_jure_liege_or_above", Scope(LandedTitle)),
    (Character, "target_is_liege_or_above", Scope(Character)),
    (Character, "target_is_same_character_or_above", Scope(Character)),
    ...
    (Character, "vassal_contract_obligation_level_can_be_decreased", Item(Item::VassalContract)),
    (Character, "vassal_contract_obligation_level_can_be_increased", Item(Item::VassalContract)),
    (Character, "vassal_contract_obligation_level_score(", CompareValue),
