...
const TRIGGER: &[(Scopes, &str, Trigger)] = &[
    ...
    (Scopes::Character, "num_of_tributaries", CompareValue),
    ...
    (Scopes::SituationSubRegion, "situation_sub_region_has_geographical_region", Scope(Scopes::GeographicalRegion)),
