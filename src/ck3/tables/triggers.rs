...
const TRIGGER: &[(Scopes, &str, Trigger)] = &[
    ...
    (Scopes::CombatSide, "allow_early_retreat", Boolean),
    ...
    (Scopes::SituationParticipantGroup, "auto_add_rulers", Boolean),
    ...
    (Scopes::Character, "can_be_tributary_of", Scope(Scopes::Character)),
    ...
    (Scopes::Character, "cease_tribute_payments_ai_chance", CompareValue),
    ...
    (Scopes::LandedTitle, "county_fertility", CompareValue),
    ...
    (Scopes::Character, "current_domain_fertility", CompareValue),
    ...
    (Scopes::CombatSide, "disallowed_retreat", Boolean),
    ...
    (Scopes::Character, "has_any_opinion_with_reason", UncheckedTodo),
    ...
    (Scopes::Character, "has_dead_character_flag", Identifier("flag name")),
    (Scopes::Character, "has_dead_character_variable", Identifier("variable name")),
    ...
    (Scopes::HoldingType, "has_holding_parameter", Item(Item::HoldingParameter)),
    ...
    (Scopes::Character, "has_obedience_reason", Scope(Scopes::Character)),
    ...
    (Scopes::HoldingType, "has_required_heir_governments", Boolean),
    ...
    (Scopes::Culture, "has_same_culture_head_determination", Scope(Scopes::Culture)),
    ...
    (Scopes::SituationSubRegion, "has_sub_region_phase_parameter", Item(Item::SituationPhaseParameter)),
    (Scopes::Character, "has_subject_contract_group", Item(Item::SubjectContractGroup)),
    ...
    (Scopes::Domicile, "herd", CompareValue),
    ...
    (Scopes::Domicile, "horde", CompareValue),
    ...
    (
        ...
        Block(&[
            ...
            ("?target_title", Scope(Scopes::LandedTitle)),
            ("?required_response", Choice(&["yes", "maybe"])),
            ("?ai_accept", CompareValue),
        ]),
    ),
    (
        Scopes::Character,
    ...
    (Scopes::Character, "is_confederation_member", Boolean),
    ...
    (Scopes::CombatSide, "is_forced_winner", Boolean),
    ...
    (Scopes::Province, "is_lake_province", Boolean),
    (Scopes::LandedTitle, "is_lakeside_county", Boolean),
    (Scopes::Province, "is_lakeside_province", Boolean),
    ...
    (Scopes::Character, "is_manual_participant", Boolean),
    (Scopes::Character, "is_married", Boolean),
    (Scopes::Character, "is_member_of_confederation", Scope(Scopes::Confederation)),
    ...
    (Scopes::Character, "is_migrating", Boolean),
    (Scopes::LandedTitle, "is_migration_target", Boolean),
    ...
    (Scopes::LandedTitle, "is_nomad_title", Boolean),
    (Scopes::Character, "is_normal_councillor", Boolean),
    (Scopes::Character, "is_obedient", Boolean),
    (Scopes::Character, "is_obedient_to", Scope(Scopes::Character)),
    ...
    (Scopes::Situation, "is_situation_unique", Boolean),
    (
        Scopes::Activity,
        "is_special_guest",
        ScopeOrBlock(
    ...
    (
        ...
        Block(&[("name", Identifier("list name")), ("*target", ScopeOkThis(Scopes::all_but_none()))]),
    ),
    (
        Scopes::None,
    ...
    (Scopes::Character, "is_tributary", Boolean),
    ...
    (Scopes::None, "list_size", Block(&[("name", Identifier("list name")), ("+value", CompareValue)])),
    ...
    (Scopes::Character, "max_domain_fertility", CompareValue),
    (Scopes::Domicile, "max_herd", CompareValue),
    ...
    (Scopes::Confederation, "member_count", CompareValue),
    ...
    (Scopes::Character, "military_power", CompareValueWarnEq),
    ...
    (Scopes::Character, "number_of_tributaries", CompareValue),
    (
        Scopes::Character,
    ...
    (Scopes::SituationParticipantGroup, "participant_group_has_character", Scope(Scopes::Character)),
    (Scopes::SituationParticipantGroup, "participant_group_type", Item(Item::SituationParticipantGroup)),
    ...
    (Scopes::SituationSubRegion, "phase_takeover_duration_days", CompareValue),
    (Scopes::SituationSubRegion, "phase_takeover_points", CompareValue),
    ...
    (Scopes::Army, "raid_intent", Item(Item::RaidIntent)),
    ...
    (Scopes::GeographicalRegion.union(Scopes::SituationSubRegion), "region_is_adjacent", Scope(Scopes::GeographicalRegion)),
    (Scopes::GeographicalRegion.union(Scopes::SituationSubRegion), "region_is_adjacent_situation_sub_region", Scope(Scopes::SituationSubRegion)),
    (Scopes::None, "release_only", Boolean),
    (Scopes::Faith, "religion_tag", Item(Item::Religion)),
    (Scopes::SituationParticipantGroup, "require_capital_in_sub_region", Boolean),
    (Scopes::SituationParticipantGroup, "require_domain_in_sub_region", Boolean),
    (Scopes::SituationParticipantGroup, "require_realm_in_sub_region", Boolean),
    ...
    (Scopes::Situation, "situation_current_phase", Item(Item::SituationPhase)),
    (Scopes::Situation, "situation_days_since_end_date", CompareValue),
    (Scopes::Situation, "situation_days_since_start_date", CompareValue),
    (Scopes::Situation, "situation_end_date", CompareDate),
    (Scopes::Situation, "situation_has_catalyst", Item(Item::SituationCatalyst)),
    (Scopes::Situation, "situation_start_date", CompareDate),
    (Scopes::SituationSubRegion, "situation_sub_region_has_county", Scope(Scopes::LandedTitle)),
    (Scopes::SituationSubRegion, "situation_sub_region_has_geographical_region", ScopeOrItem(Scopes::GeographicalRegion, Item::Region)),
    (Scopes::SituationSubRegion, "situation_sub_region_has_province", Scope(Scopes::Province)),
    (Scopes::Situation, "situation_top_has_catalyst", Item(Item::SituationCatalyst)),
    (Scopes::Situation, "situation_top_has_county", Scope(Scopes::LandedTitle)),
    (Scopes::Situation, "situation_top_has_province", Scope(Scopes::Province)),
    (Scopes::Situation, "situation_type", Item(Item::Situation)),
    (Scopes::CombatSide, "skip_pursuit", Boolean),
    (
    ...
    (Scopes::SituationSubRegion, "sub_region_current_phase", Item(Item::SituationPhase)),
    (Scopes::Character, "subject_can_break_tributary", Boolean),
    ...
    (Scopes::LandedTitle, "uses_county_fertility", Boolean),
    ...
    (Scopes::Character, "vassal_contract_has_flag", Item(Item::SubjectContractFlag)),
...
const TRIGGER_COMPLEX: &[(Scopes, &str, ArgumentValue, Scopes)] = {
    ...
    &[
        ...
        (
            ...
            ScopeOrItem(Scopes::VassalObligationLevel, Item::SubjectContract),
            Scopes::Value,
        ),
