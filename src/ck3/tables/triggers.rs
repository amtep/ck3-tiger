...
const TRIGGER: &[(Scopes, &str, Trigger)] = &[
    ...
    (Scopes::Legend, "days_since_legend_creation", CompareValue),
    ...
    // TODO: docs are probably wrong on this one.
    (Scopes::Province, "days_since_province_infection", CompareValue),
    ...
    (Scopes::Province, "province_infection_date", CompareDate),
    (Scopes::Province, "province_infection_rate", CompareValueWarnEq),
