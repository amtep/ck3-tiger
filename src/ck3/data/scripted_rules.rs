...
const SCRIPTED_RULE_ROOTS: &[(&str, Scopes, Tooltipped)] = &[
    ...
    ("ghw_give_barony_to_beneficiary", Scopes::Province, Tooltipped::No),
    ("faith_creation", Scopes::Character, Tooltipped::Yes),
    ("faith_conversion", Scopes::Character, Tooltipped::Yes),
    ("should_mother_give_house_to_bastard", Scopes::Character, Tooltipped::No),
    ("can_be_knight", Scopes::Character, Tooltipped::No),
    ("allowed_to_be_granted_titles_by", Scopes::Character, Tooltipped::Yes),
    ("is_character_allowed_to_be_player", Scopes::Character, Tooltipped::Yes),
    ("is_secret_available_for_blackmail", Scopes::Secret, Tooltipped::No),
    ("passes_faction_hard_block", Scopes::Character, Tooltipped::Yes),
    ("passes_faction_soft_block", Scopes::Character, Tooltipped::Yes),
    ...
    ("cares_about_powerful_vassal_council_position", Scopes::Character, Tooltipped::No),
    ("approves_of_succession_law_change", Scopes::Character, Tooltipped::No), // TODO: verify
    ("has_natural_death_second_chance", Scopes::Character, Tooltipped::No),
    ("can_refund_perks", Scopes::Character, Tooltipped::Yes),
    ("can_defensively_join_holy_war", Scopes::Character, Tooltipped::No),
    ...
    ("is_hard_blocked_from_schemes", Scopes::Character, Tooltipped::No),
    ("ai_wants_matrilineal_marriage", Scopes::Character, Tooltipped::No),
    ("ai_wants_grand_wedding_promise", Scopes::Character, Tooltipped::No),
    ("buildings_enabled", Scopes::Character, Tooltipped::Yes),
    ("can_potentially_call_ally", Scopes::Character, Tooltipped::No),
    ...
    ("is_eligible_for_court_positions", Scopes::Character, Tooltipped::No),
    ("can_name_after_birth", Scopes::Character, Tooltipped::No),
    ("can_adopt_court_language", Scopes::Character, Tooltipped::No),
    ("ai_should_repair_artifact", Scopes::Character, Tooltipped::No),
    ("can_be_activity_guest", Scopes::Character, Tooltipped::No),
    ("is_diarch_visibly_loyal", Scopes::Character, Tooltipped::No),
    ("is_diarch_visibly_disloyal", Scopes::Character, Tooltipped::No),
