...
use tiger_lib::{
    ...
    set_show_vanilla, update, validate_config_file, Everything, Game, ModFile,
};
    ...
    match cli.command {
        ...
        None => {
            ...
            if args.imperator.is_none() {
                args.imperator =
                    find_game_directory_steam(IMPERATOR_APP_ID, &PathBuf::from(IMPERATOR_DIR));
            }
